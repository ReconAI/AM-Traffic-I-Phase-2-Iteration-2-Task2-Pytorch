...
```sh
python3 predict_video_torch.py --model ./models/pytorch/road_model.pt --weights  ./models/pytorch/weights_road.pth --input ./test_video.mp4 --labels ./road_labels.json --output ./output_road_torch/road_conditions_pie.avi --size 128
```
Where:
